...
export default function UrunEkle() {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post("http://localhost:8080/urun-ekle", formData, {
            headers: {
            ...
            .then(response => {
                if (response.data.message) {
                    ...
                    alert("Ürün eklenirken hata oluştu, Ürün Eklenemedi");
                }
            });
    };
            ...
            <form onSubmit={handleSubmit} className="space-y-8 divide-y divide-gray-200">
                <div className="space-y-8 divide-y divide-gray-200 sm:space-y-5">
                    <div>
                        ...
                        <div>
                            <h3 className="text-lg leading-6 font-medium text-gray-900">Ürün Ekle</h3>
                            <p className="mt-1 max-w-2xl text-sm text-gray-500">
                                Ürün Eklemek İçin Aşağıdaki Formu Doldurunuz.
                            </p>
                        </div>
                        ...
                        <div className="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
                                    ...
                                    <div className="max-w-lg flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                                        <div className="space-y-1 text-center">
                                            ...
                                            <div className="flex text-sm text-gray-600">
                                                ...
                                                <p className="pl-1">yada sürükle</p>
                                            </div>
                            ...
                            <div className="w-full flex justify-end sm:border-t sm:border-gray-200 sm:pt-5">
                                <button
                                    type="submit"
                                    className="w-44 bg-indigo-600 flex items-center justify-center py-2 text-white font-medium text-md rounded-md hover:bg-indigo-700"
                                >
                                    Oluştur
                                </button>
                            </div>
